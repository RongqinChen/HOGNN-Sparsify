...
from evaluators import MultilabelRegressionEvaluator
...
def main():
    ...
    # ======== load dataset ==============
    train_set = LRGBDataset("peptides-struct", cfg.dataset.path, "train", cfg.dataset.full_pre_transform,
                            cfg.dataset.inmemory_transform, cfg.dataset.onthefly_transform)
    valid_set = LRGBDataset("peptides-struct", cfg.dataset.path, "val", cfg.dataset.full_pre_transform,
                            cfg.dataset.inmemory_transform, cfg.dataset.onthefly_transform)
    test__set = LRGBDataset("peptides-struct", cfg.dataset.path, "test", cfg.dataset.full_pre_transform,
                            cfg.dataset.inmemory_transform, cfg.dataset.onthefly_transform)
    ...
    evaluator = MultilabelRegressionEvaluator()
